		...
		<div className="bg-primary h-screen w-full flex">
			...
			<div className="flex flex-col items-center justify-between bg-white w-80 h-screen pt-6 ">
				...
				<div className="flex flex-col justify-between h-72	">
					<div className="flex w-52 justify-between text-black text-2xl font-normal font-jacques">
						<p>Dashboard</p>
						<div className="p-2">
							<svg
								width="18"
					...
					<div className="flex w-52 justify-between items-end text-black text-2xl font-normal font-jacques">
						<p>Search Tuitions</p>
						<div className="p-2">
							<svg
								width="20"
			...
			<div className="p-2 w-full flex-col gap-4">
				...
				<div className="w-content h-content bg-white rounded-[3rem] mt-2 pt-14  flex flex-col gap-12 ">
					...
					<div className="flex">
						<div className="w-80 h-28 bg-[#D6C0F2] rounded-tr-[3rem] rounded-bl-[3rem]"></div>
						<div className="w-28 h-28 bg-violet-200 rounded-full"></div>
						<div>
							<img
								src=""
								alt=""
								className="w-52 h-28 rounded-tr-3xl border border-violet-500"
							/>
						</div>
						<div className="w-56 h-28 bg-purple-300 rounded-tl-[3rem] rounded-bl-[3rem] rounded-br-[3rem]"></div>
					</div>
				</div>
				{/* enrolled carousel */}
